export const getArticles = (articles, nextPage, cb) => {
	const url = nextPage !== null ? nextPage : `/api/v2/help_center/${window.I18n.locale}/articles.json?per_page=100`
...
export const getSections = (sections, nextPage, cb) => {
	const url = nextPage !== null ? nextPage : `/api/v2/help_center/${window.I18n.locale}/sections.json?per_page=100`
...
export const getCategories = (categories, nextPage, cb) => {
	const url = nextPage !== null ? nextPage : `/api/v2/help_center/${window.I18n.locale}/categories.json?per_page=100`
